...
def register(region):
    ...
    hs = {"Authorization":f"Bearer {at}","X-Unity-Version":"2018.4.11f1","X-GA":"v1 1","ReleaseVersion":"OB54","Content-Type":"application/octet-stream","Content-Length":str(len(ed)),"User-Agent":ua,"Host":"loginbp.ggblueshark.com","Connection":"Keep-Alive","Accept-Encoding":"gzip"}
